...
import org.teiid.authoring.client.animations.FadeOutAnimation;
...
public class NotificationService {
    ...
    private void createNotificationWidget(final Notification notification) {
        ...
        widget.addMouseInHandler(new org.teiid.authoring.client.events.MouseInEvent.Handler() {
            @Override
        ...
        widget.addMouseOutHandler(new org.teiid.authoring.client.events.MouseOutEvent.Handler() {
            @Override
