...
import org.teiid.authoring.client.resources.TeiidSimplePagerResources;
 ...
 */
public class TeiidSimplePager extends AbstractPager {
    ...
    private static TeiidSimplePagerResources DEFAULT_RESOURCES;

    private static TeiidSimplePagerResources getDefaultResources() {
        if ( DEFAULT_RESOURCES == null ) {
            DEFAULT_RESOURCES = TeiidSimplePagerResources.INSTANCE;
        }
    ...
    /**
     * The {@link TeiidSimplePagerResources} used by this widget.
     */
    private final TeiidSimplePagerResources resources;
     ...
     */
    public TeiidSimplePager( TextLocation location ) {
        this( location,
              getDefaultResources(),
              true,
     ...
     */
    public TeiidSimplePager( TextLocation location,
                                TeiidSimplePagerResources resources,
