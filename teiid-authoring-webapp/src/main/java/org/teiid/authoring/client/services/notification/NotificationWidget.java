 ...
 */
package org.teiid.authoring.client.services.notification;
...
import org.teiid.authoring.client.events.MouseInEvent.HasMouseInHandlers;
import org.teiid.authoring.client.events.MouseOutEvent;
import org.teiid.authoring.client.events.MouseOutEvent.HasMouseOutHandlers;
import org.teiid.authoring.share.beans.NotificationType;
 ...
 */
@Templated("./growl-dialog.html#growl-dialog")
@Dependent
public class NotificationWidget extends Composite implements HasMouseInHandlers, HasMouseOutHandlers {
    ...
    public HandlerRegistration addMouseOutHandler(
            org.teiid.authoring.client.events.MouseOutEvent.Handler handler) {
    ...
    public HandlerRegistration addMouseInHandler(
    		org.teiid.authoring.client.events.MouseInEvent.Handler handler) {
